...
└── src/
    ...
    ├── store/              # Gestão de Estado Global (Zustand: GameStore)
    ├── services/           # Regras de Negócio e Ingestão (ingestor.service, coach.service)
...
4. **Configurar Variáveis de Ambiente:**
   ...
   ```env
   DATABASE_URL="postgresql://user:password@localhost:5432/chess-openings?schema=public"
   ```
...
Acede a [http://localhost:3000](http://localhost:3000) e bem-vindo ao teu novo clube de xadrez!
