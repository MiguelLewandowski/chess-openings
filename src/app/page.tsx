...
import { BookOpen, Target, Sparkles, ChevronRight, User, BrainCircuit } from "lucide-react";
      ...
      <header className="relative z-10 border-b border-white/5 bg-slate-950/50 backdrop-blur-xl">
        <div className="max-w-6xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-4 sm:gap-6">
            <Link href="/admin/import" className="hidden sm:inline-block text-sm font-medium text-slate-400 hover:text-white transition-colors">
              Administration
            </Link>
